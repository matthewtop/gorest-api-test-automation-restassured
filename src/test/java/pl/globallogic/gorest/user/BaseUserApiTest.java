...
public class BaseUserApiTest {
    ...
    @BeforeMethod
    public void testSetUp(Method method){logger.info("Running '{}' test", method.getName());}

    @AfterMethod
    public void testTearDown(Method method){logger.info("Finishing '{}' test", method.getName());}
